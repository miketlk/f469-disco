...
#define LV_DRAW_BUF_STRIDE_ALIGN                (sizeof(uintptr_t))

/*Align the start address of draw_buf addresses to this bytes*/
#define LV_DRAW_BUF_ALIGN                       (sizeof(uintptr_t))
...
#define LV_ATTRIBUTE_MEM_ALIGN_SIZE (sizeof(uintptr_t))

/*Will be added where memories needs to be aligned (with -Os data might not be aligned to boundary by default).
 * E.g. __attribute__((aligned(4)))*/
#define LV_ATTRIBUTE_MEM_ALIGN __attribute__((aligned(sizeof(uintptr_t))))
